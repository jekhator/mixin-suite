...
class TestFromDataclass:
    ...
    def test_reads_tagged_fields_into_classes_tuple(
    ...
    def test_preserves_field_declaration_order(self, mixed_type: type[Any]) -> None:
    ...
    def test_excludes_untagged_fields(self, mixed_type: type[Any]) -> None:
    ...
    def test_empty_classes_when_no_tags(self, unclassified_type: type[Any]) -> None:
    ...
    def test_returns_sensitivity_profile_instance(self, mixed_type: type[Any]) -> None:
...
class TestIsEmpty:
    ...
    def test_true_when_no_tags(self, unclassified_type: type[Any]) -> None:
        """is_empty is True when classes tuple is empty."""
        profile = SensitivityProfile.from_dataclass(unclassified_type)
        assert profile.is_empty is True

    def test_false_when_tags_exist(self, mixed_type: type[Any]) -> None:
...
class TestSensitivityOf:
    ...
    def test_returns_sensitivity_for_tagged_field(self, mixed_type: type[Any]) -> None:
    ...
    def test_returns_none_for_untagged_field(self, mixed_type: type[Any]) -> None:
    ...
    def test_returns_none_for_absent_field_name(self, mixed_type: type[Any]) -> None:
    ...
    def test_returns_none_on_empty_profile(self, unclassified_type: type[Any]) -> None:
...
class TestHas:
    ...
    def test_true_when_sensitivity_present(self, mixed_type: type[Any]) -> None:
    ...
    def test_false_when_sensitivity_absent(self, unclassified_type: type[Any]) -> None:
...
class TestFieldsOf:
    ...
    def test_returns_field_names_for_present_class(self, mixed_type: type[Any]) -> None:
    ...
    def test_returns_empty_tuple_for_absent_class(
    ...
    def test_preserves_field_order_in_return_tuple(self, mixed_type: type[Any]) -> None:
...
class TestFrozenProfile:
    ...
    def test_two_profiles_with_same_classes_are_equal(
        self, mixed_type: type[Any]
    ) -> None:
...
class TestClassifyBinding:
    ...
    def test_classify_returns_profile(self, mixed_type: type[Any]) -> None:
