"""BotocoreCorrelation value object for botocore event-hook surfaces."""
...
class BotocoreCorrelation:
    """Value object capturing the correlation_id to inject into outbound botocore requests."""
    ...
    def header_tuple(self) -> tuple[str, str]:
        """Return (header_name, correlation_id) ready for outbound request assignment."""
